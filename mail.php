...
$kitchenSize = $_POST['kitchenSize'];
$userFasad = $_POST['fasad'];
$userStyle = $_POST['style'];
$formaKuh = $_POST['formaKuh'];
$ostrov = $_POST['ostrov'];
$base = $_POST['base'];
